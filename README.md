# ![nf-core/magmap](docs/images/nf-core-magmap_logo.png)
...
**nf-core/magmap** is a bioinformatics best-practice analysis pipeline for A pipeline that maps reads to a collections of genomes..
...
See [usage docs](https://nf-co.re/magmap/usage) for all of the available options when running the pipeline.

## Documentation

The nf-core/magmap pipeline comes with documentation about the pipeline: [usage](https://nf-co.re/magmap/usage) and [output](https://nf-co.re/magmap/output).
